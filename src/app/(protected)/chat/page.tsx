...
{isConnected ? t('connected') : t('disconnected')}
          ...
          <Card>
            ...
            <CardContent>
              <ul className="text-sm text-gray-600 space-y-1">
                <li>• {t('realTimeTextChat')}</li>
                <li>• {t('instantAiResponses')}</li>
                <li>• {t('enterKeyToSend')}</li>
                <li>• {t('messageHistory')}</li>
                <li>• {t('whatsappStyleBubbles')}</li>
              </ul>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <ul className="text-sm text-gray-600 space-y-1">
                ...
                <li>• {t('noiseReduction')}</li>
                <li>• {t('realTimeDurationTracking')}</li>
        ...
        <Card className="mt-8">
          <CardHeader>
            ...
            <CardDescription>
              {t('completeChatExperience')}
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div>
                <h4 className="font-medium mb-3">{t('textMessages')}</h4>
                <ol className="text-sm text-gray-600 space-y-2">
                  <li>1. {t('typeMessageInput')}</li>
                  <li>2. {t('pressEnterSend')}</li>
                  <li>3. {t('messageAppearsChat')}</li>
                  <li>4. {t('aiProcessesResponds')}</li>
                  <li>5. {t('responseAppearsText')}</li>
                </ol>
              </div>
              <div>
                <h4 className="font-medium mb-3">{t('voiceMessages')}</h4>
                <ol className="text-sm text-gray-600 space-y-2">
                  <li>1. {t('pressMicrophoneRecord')}</li>
                  <li>2. {t('speakMessage', { maxDuration: settings.maxDuration.toString() })}</li>
                  <li>3. {t('pressStopFinish')}</li>
                  <li>4. {t('previewPlayback')}</li>
                  <li>5. {t('pressSendSubmit')}</li>
                  <li>6. {t('receiveAiTranscription')}</li>
                </ol>
              </div>
              <div>
                <h4 className="font-medium mb-3">{t('n8nIntegration')}</h4>
                <ol className="text-sm text-gray-600 space-y-2">
                  <li>1. {t('receivesTextVoice')}</li>
                  <li>2. {t('processesAudioTranscription')}</li>
                  <li>3. {t('generatesContextualAi')}</li>
                  <li>4. {t('returnsTextAudio')}</li>
                  <li>5. {t('supportsMixedConversation')}</li>
                </ol>
              </div>
            </div>
          </CardContent>

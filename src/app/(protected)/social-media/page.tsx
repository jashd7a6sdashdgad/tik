    ...
    <div className="container mx-auto px-4 py-8 max-w-7xl">
      ...
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-black">Social Media Integration</h1>
            <p className="text-black">Comprehensive social media management for mahboobagents.fun</p>
          </div>
        </div>
